...
@section('title', 'Tambah Pengguna - Desa Renged')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-6 border-b border-gray-100 bg-gray-50/50">
            ...
            <p class="text-gray-500 text-sm mt-1">Buat akun baru untuk administrasi atau warga desa.</p>
        </div>

        <div class="p-8">
            <form action="{{ route('operator.users.store') }}" method="POST" class="space-y-8">
                @csrf
                         ...
                         <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password" required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-3 transition-all focus:bg-white placeholder-gray-400" placeholder="Minimal 8 karakter">
                            </div>
                        </div>
                        <!-- Konfirmsi Password -->
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password_confirmation" required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-3 transition-all focus:bg-white placeholder-gray-400" placeholder="Ulangi password">
                            </div>
                        </div>
                    </div>
                </div>
