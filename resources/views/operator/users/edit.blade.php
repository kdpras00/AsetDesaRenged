                         ...
                         <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password"
                                    class="bg-white border border-yellow-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full pl-10 p-3 transition-all placeholder-yellow-400" placeholder="Minimal 8 karakter">
                            </div>
                        </div>
                        <!-- Konfirmsi Password -->
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password_confirmation"
                                    class="bg-white border border-yellow-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full pl-10 p-3 transition-all placeholder-yellow-400" placeholder="Ulangi password">
                            </div>
                        </div>
                    </div>
                </div>
