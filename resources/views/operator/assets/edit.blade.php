...
@section('title', 'Edit Aset - Desa Renged')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-6 border-b border-gray-100 bg-gray-50/50">
            <h1 class="text-xl font-bold text-gray-900">Edit Data Aset</h1>
            <p class="text-gray-500 text-sm mt-1">Perbarui informasi inventaris aset desa.</p>
        </div>

        <div class="p-8">
            <form action="{{ route('operator.assets.update', $asset) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="quantity" value="{{ old('quantity', $asset->quantity) }}" min="1" required
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm relative mt-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                        ...
                        <div class="md:col-span-2">
                             ...
                             <div class="relative">
                                ...
                                <textarea name="description" rows="3" 
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-3 transition-all placeholder-gray-400 focus:bg-white">{{ old('description', $asset->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="condition" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-3 transition-all focus:bg-white appearance-none">
                                    ...
                                    <option value="rusak_berat" {{ old('condition', $asset->condition) == 'rusak_berat' ? 'selected' : '' }}>Rusak Berat (Afkir)</option>
                                </select>
                                <div class="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none">
                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                                </div>
                        ...
                        <!-- Foto -->
                        <div class="md:col-span-2">
                            <label class="block mb-2 text-sm font-semibold text-gray-700">Update Foto Aset</label>
                             @if($asset->image)
                                <div class="mb-3 flex items-center p-3 bg-blue-50 border border-blue-100 rounded-lg max-w-xs">
                                    <img src="{{ Storage::url($asset->image) }}" class="h-16 w-16 object-cover rounded border border-blue-200 mr-3">
                                    <div>
                                        <p class="text-xs text-blue-800 font-semibold">Foto Saat Ini</p>
                                        <p class="text-xs text-blue-600">Klik area upload untuk mengganti.</p>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div id="image-preview" class="mt-4 hidden">
                                <span class="text-sm text-gray-500 mb-2 block">Preview Baru:</span>
