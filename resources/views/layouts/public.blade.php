    ...
    <div class="bg-blue-900 text-white py-2 text-sm hidden md:block border-b border-blue-800">
        <div class="max-w-screen-xl mx-auto px-4 flex justify-between items-center">
            ...
            <div class="flex space-x-4">
                ...
                <a href="#" class="hover:text-blue-300 transition-colors">Instagram</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                     ...
                     <ul class="space-y-2">
                         ...
                         <li><a href="#" class="hover:text-white hover:translate-x-1 transition-all inline-block">Peta Desa</a></li>
                     </ul>
                </div>
