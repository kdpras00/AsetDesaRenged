    ...
    <div class="content">
        ...
        <table class="table-data" style="margin-left: 0px;">
            ...
            <tr>
                ...
                <td class="label-text-col">Warganegara</td>
                <td class="separator-col">:</td>
                <td>Indonesia</td>
            </tr>
            <tr>
                <td class="label-col">6.</td>
                <td class="label-text-col">Agama</td>
                <td class="separator-col">:</td>
                <td>{{ $letter->user->religion ?? '-' }}</td>
            </tr>
            <tr>
                <td class="label-col">7.</td>
                <td class="label-text-col">Pekerjaan</td>
                <td class="separator-col">:</td>
        ...
        <p>
            Benar menurut keterangan dari RT/RW setempat dan keterangan yang bersangkutan, Selanjutnya bahwa <strong>Nama</strong> tersebut diatas pada saat ini telah Berdomisili di:
        </p>
