...
<body>
    ...
    <div class="title">
        <h4>SURAT KETERANGAN TIDAK MEMILIKI IJAZAH</h4>
        <p>Nomor : 560.1 / {{ $letter->letter_number ?? '.......' }} - Ds.Rgd / {{ \App\Helpers\Romawi::get(date('n')) }} / {{ date('Y') }}</p>
    </div>
    ...
    <div class="content">
        ...
        <p>
            Nama tersebut diatas adalah benar Penduduk Desa Renged Kec.Kresek Kab.Tangerang. Berdasarkan keterangan dari RT/RW setempat, dan pengakuan yang bersangkutan bahwa benar <u><strong>TIDAK MEMILIKI IJAZAH</strong></u>.
        </p>
